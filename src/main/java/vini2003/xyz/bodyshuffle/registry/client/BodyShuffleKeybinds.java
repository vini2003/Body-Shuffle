...
public class BodyShuffleKeybinds {
	public static final KeyBinding keyBodyPartSelectorScreen = KeyBindingHelper.registerKeyBinding(new KeyBinding("key.bodyshuffle.open_body_part_selector", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_V, "category.bodyshuffle.bodyshuffle"));
